...
class AsyncDifyClient:
    ...
    async def text_to_audio(
        self, text: str, user: str, streaming: bool = False
    ):
    ...
    async def update_app_site_config(
        self, app_id: str, config_data: Dict[str, Any]
    ):
...
class AsyncChatClient(AsyncDifyClient):
    ...
    async def stop_message(self, task_id: str, user: str):
        ...
        data = {"user": user}
        return await self._send_request(
            "POST", f"/chat-messages/{task_id}/stop", data
        )
    ...
    async def audio_to_text(
        self, audio_file: Union[IO[bytes], tuple], user: str
    ):
    ...
    async def delete_annotation(self, annotation_id: str):
        ...
        return await self._send_request(
            "DELETE", f"/apps/annotations/{annotation_id}"
        )
...
class AsyncWorkflowClient(AsyncDifyClient):
    ...
    async def get_result(self, workflow_run_id: str):
        ...
        return await self._send_request(
            "GET", f"/workflows/run/{workflow_run_id}"
        )
    ...
    async def update_workflow_draft(
        self, app_id: str, workflow_data: Dict[str, Any]
    ):
...
class AsyncKnowledgeBaseClient(AsyncDifyClient):
    ...
    async def create_dataset(self, name: str, **kwargs):
        ...
        return await self._send_request(
            "POST", "/datasets", {"name": name}, **kwargs
        )
    ...
    async def add_segments(
        self, document_id: str, segments: list[dict], **kwargs
    ):
    ...
    async def bind_dataset_tags(self, tag_ids: List[str]):
        ...
        return await self._send_request(
            "POST", "/datasets/tags/binding", json=data
        )
    ...
    async def unbind_dataset_tag(self, tag_id: str):
        ...
        return await self._send_request(
            "POST", "/datasets/tags/unbinding", json=data
        )
    ...
    async def create_dataset_from_template(
        ...
        return await self._send_request(
            "POST", "/datasets/from-template", json=data
        )
...
class AsyncEnterpriseClient(AsyncDifyClient):
    ...
    async def invite_member(
        self, email: str, role: str, name: str | None = None
    ):
    ...
    async def update_role_permissions(
        self, role_id: str, permissions: List[str]
    ):
    ...
    async def update_subscription(self, subscription_data: Dict[str, Any]):
        ...
        return await self._send_request(
            "PUT", "/subscription", json=subscription_data
        )
    ...
    async def get_billing_history(self, page: int = 1, limit: int = 20):
        ...
        params = {"page": page, "limit": limit}
        return await self._send_request(
            "GET", "/billing/history", params=params
        )
    ...
    async def export_audit_logs(
        ...
        return await self._send_request(
            "GET", "/audit/logs/export", params=params
        )
...
class AsyncSecurityClient(AsyncDifyClient):
    ...
    async def list_api_keys(
        ...
        if status:
            params["status"] = status
        return await self._send_request(
            "GET", "/security/api-keys", params=params
        )
    ...
    async def update_security_settings(self, settings_data: Dict[str, Any]):
        ...
        return await self._send_request(
            "PUT", "/security/settings", json=settings_data
        )
    ...
    async def get_security_audit_logs(
        ...
        if end_date:
            params["end_date"] = end_date
        return await self._send_request(
            "GET", "/security/audit-logs", params=params
        )
    ...
    async def update_ip_whitelist(
        ...
        if description:
            data["description"] = description
        return await self._send_request(
            "PUT", "/security/ip-whitelist", json=data
        )
    ...
    async def update_ip_blacklist(
        ...
        if description:
            data["description"] = description
        return await self._send_request(
            "PUT", "/security/ip-blacklist", json=data
        )
...
class AsyncAnalyticsClient(AsyncDifyClient):
    ...
    async def get_user_analytics(
        ...
        return await self._send_request(
            "GET", "/analytics/users", params=params
        )
    ...
    async def get_performance_metrics(
        ...
        if metric_type:
            params["metric_type"] = metric_type
        return await self._send_request(
            "GET", "/analytics/performance", params=params
        )
    ...
    async def get_cost_analytics(
        ...
        return await self._send_request(
            "GET", "/analytics/costs", params=params
        )

    async def get_app_cost_analytics(
        self, app_id: str, start_date: str, end_date: str
    ):
    ...
    async def list_custom_reports(self, page: int = 1, limit: int = 20):
        ...
        params = {"page": page, "limit": limit}
        return await self._send_request(
            "GET", "/analytics/reports", params=params
        )
    ...
    async def export_analytics_data(
        ...
        return await self._send_request(
            "GET", "/analytics/export", params=params
        )
...
class AsyncIntegrationClient(AsyncDifyClient):
    ...
    async def list_webhooks(
        ...
        if status:
            params["status"] = status
        return await self._send_request(
            "GET", "/integrations/webhooks", params=params
        )
    ...
    async def get_webhook_logs(
        self, webhook_id: str, page: int = 1, limit: int = 20
    ):
    ...
    async def list_plugins(
        ...
        return await self._send_request(
            "GET", "/integrations/plugins", params=params
        )
    ...
    async def list_backups(self, page: int = 1, limit: int = 20):
        ...
        params = {"page": page, "limit": limit}
        return await self._send_request(
            "GET", "/integrations/backup", params=params
        )
...
class AsyncAdvancedModelClient(AsyncDifyClient):
    ...
    async def list_registry_models(
        ...
        return await self._send_request(
            "GET", "/models/registry", params=params
        )

    async def register_model(self, model_config: Dict[str, Any]):
        """Register a new model in the registry."""
        return await self._send_request(
            "POST", "/models/registry", json=model_config
        )
...
class AsyncAdvancedAppClient(AsyncDifyClient):
    ...
    async def duplicate_app(
        self, app_id: str, duplicate_config: Dict[str, Any]
    ):
    ...
    async def list_app_versions(
        self, app_id: str, page: int = 1, limit: int = 20
    ):
    ...
    async def create_app_version(
        self, app_id: str, version_config: Dict[str, Any]
    ):
    ...
    async def update_app_advanced_config(
    ...
    async def update_app_resource_limits(
        self, app_id: str, limits: Dict[str, Any]
    ):
